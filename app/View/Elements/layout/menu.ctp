<?php 
$url_add_challenge = $this->Html->url(array('controller' => 'contents', 'action' => 'add', 'challenge'));
$url_add_idea = $this->Html->url(array('controller' => 'contents', 'action' => 'add', 'idea'));
$url_add_vision = $this->Html->url(array('controller' => 'contents', 'action' => 'add', 'vision'));

$url_view_challenge = $this->Html->url(array('controller' => 'contents', 'action' => 'challenge'));
...
<div class="left">
	<ul>
		<li id="home" class="deepblue"><a href="<?php echo $this->Html->url('/'); ?>">Home</a></li>
		...
		<li id="campaigns" class="deepblue"><a href="<?php echo $url_view_campaigns; ?>">Campaigns</a></li>
